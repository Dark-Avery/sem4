...
enum type_of_lex {
    LEX_NULL,                                                           //0
	LEX_AND, LEX_BOOL, LEX_STRING, LEX_DO, LEX_ELSE, LEX_IF,            //6
	LEX_FALSE, LEX_INT, LEX_NOT, LEX_OR, LEX_PROGRAM, LEX_READ ,        //12
	LEX_THEN, LEX_TRUE, LEX_VAR, LEX_WHILE, LEX_WRITE, LEX_GOTO,        //18
    LEX_BREAK, LEX_FOR,                                                 //20
	LEX_FIN,                                                            //21
	LEX_SEMICOLON, LEX_DOG, LEX_COMMA, LEX_COLON, LEX_ASSIGN, LEX_OPPAR,//27
	LEX_CLPAR, LEX_EQ, LEX_L, LEX_G, LEX_PLUS, LEX_MINUS, LEX_MULT,     //34
	LEX_DIV, LEX_LEQ, LEX_NEQ, LEX_GEQ, LEX_DQM, LEX_FIGOP, LEX_FIGCL,  //41
	LEX_STRINGCONST, LEX_NUM, LEX_ID,    
    POLIZ_LABEL,                                                                                /*38*/
    POLIZ_ADDRESS,                                                                              /*39*/
    POLIZ_GO,                                                                                   /*40*/
    POLIZ_FGO                              //44
...
public:
    ...
    void put_value_string (string& buf) {
        value_string = buf;
    }
};
...
Scanner::TW    [] = { "", "and", "bool", "string", "do", "else", "if", "false", "int", "not", "or", "program",
                    "read", "then", "true", "var", "while", "write", "goto", "break", "for", NULL };
...
Lex Scanner::get_lex () {
    enum    state { H, IDENT, NUMB, ALE, NOTEQ, STRING, COM_BEG, COM_END, COM, COM_WRONG };
    int     d, j;
    string  buf, s;
    state   CS = H;
    for(;;) {
